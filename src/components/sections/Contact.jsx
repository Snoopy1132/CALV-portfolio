            ...
            <div className="px-4 w-150">
                ...
                <form className="space-y-6" onSubmit={handleSubmit}>
                    <div className="relative">
                        ...
                        value={formData.name}
                        className="w-full bg-white/5 border border-blue/10 rounded px-4 py-3 text-white transition focus:outline-none focus:border-blue-500 focus:bg-blue-500/5" 
                        placeholder="Name..."
